...
[0,0,0,\&heading,'RateLimit Options'],
 ...
 ['RLIBTmsgAnyBlockedSpam','Any Blocked Spam Messages Limit/Interval/BlockTime',10,\&RLIBTtextinput,'1/1h/1d','(\d+\/\d+[smhd]?\/\d+[smhd]?)',\&configUpdateRLIBT,
  '<span class="negative"><b>Any Blocked Spam Messages</b></span> rate limit.<br />
   ...
   <a href="/#RLIBTviridetected">Virus-infected messages</a>, <a href="/#RLIBTbspams">Bayesian spam messages</a>,
   <a href="/#RLIBTmsgServerRejected">Server Rejected messages</a>.',undef],
 ...
 ['RLIBTmsgServerRejected','Server Rejected Messages Limit/Interval/BlockTime',10,\&RLIBTtextinput,'0/0/0','(\d+\/\d+[smhd]?\/\d+[smhd]?)',\&configUpdateRLIBT,
  '<span class="negative"><b>Server Rejected messages</b></span> rate limit.',undef],
