...
[0,0,0,\&heading,'Client Validation'],
 ...
 ['HeloPosition','HELO Check Position',1,\&radio,4,'([1-4])',undef,
  '',{'1'=>'early (pre-mailfrom) -- no opt-outs nor failures collecting',
      '2'=>'early (pre-rcpt) -- skips noprocessing, local, whitelisted or authenticated mails',
...
[0,0,0,\&heading,'Sender Validation'],
 ...
 ['SenderPosition','Sender Check Position',1,\&radio,3,'([1-3])',undef,
  '',{'1'=>'early (pre-rcpt) -- skips noprocessing, local, whitelisted or authenticated mails',
...
[0,0,0,\&heading,'Whitelist Options'],
 ...
 ['RWLPosition','RWL Check Position',1,\&radio,5,'([1-5])',undef,
  '',{'1'=>'early (on-connect) -- no opt-outs nor failures collecting',
      '2'=>'early (pre-banner) -- as above, but after Greeting Delay',
      '3'=>'early (pre-rcpt) -- skips noprocessing, local, whitelisted or authenticated mails',
 ...
 ['SPFWL','Whitelisted SPF Validation',0,\&checkbox,1,'(.*)',undef,
  'Enable Sender Policy Framework Validation for whitelisted senders also.',undef],
 ['RBLWL','Whitelisted RBL Validation',0,\&checkbox,1,'(.*)',undef,
  'Enable RBL for whitelisted senders also.',undef],
 ['MsgVerifyWL','Whitelisted Message Verification',0,\&checkbox,'','(.*)',undef,
  'Enable Message Verification for whitelisted senders also.',undef],
 ['URIBLWL','Whitelisted URIBL Validation',0,\&checkbox,1,'(.*)',undef,
  'Enable URIRBL for whitelisted senders also.',undef],
 ['RateLimitWL','Whitelisted RateLimiting',0,\&checkbox,'','(.*)',undef,
  'Enable RateLimit for whitelisted senders also.',undef],
